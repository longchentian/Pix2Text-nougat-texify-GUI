...
class App(QMainWindow):
    ...
    def returnSnip(self, img=None):
        ...
        self.thread = ModelThread(img=img, model=self.model,processor=self.processor,mode=self.args.mode,temp=self.args.temperature)
...
class ModelThread(QThread):
    ...
    def __init__(self, img, model,processor,mode,temp):
        super().__init__()
        self.img = img
        self.model = model
